...
import adminexecs from '../../../execs_2324/admin.json';
import eventsexecs from '../../../execs_2324/events.json';
import socialmediaexecs from '../../../execs_2324/socialmedia.json';
...
export default function MeetTheExecs() {
  return (
    <>
    <ResponsiveAppBar/>
    <Typography className="title"> Meet The Execs 2023 - 2024</Typography>
